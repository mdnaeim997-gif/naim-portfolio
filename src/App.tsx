...
function App() {
  ...
  // আপনার প্রজেক্টের তালিকা ও লিংকগুলো এখানে আছে
  const projects = [
    {
        ...
        {activeTab === 'home' && (
          <div className="py-20 flex flex-col items-center text-center">
            ...
            <p className="text-slate-400 max-w-2xl text-lg mb-8">
              আমি আধুনিক এবং রেসপন্সিভ ওয়েব অ্যাপ্লিকেশন তৈরি করি। নিচে আমার তৈরি প্রজেক্টগুলো দেখতে পাবেন।
            </p>
        ...
        {activeTab === 'about' && (
          <div className="py-12 max-w-2xl mx-auto">
            ...
            <p className="text-slate-300 leading-relaxed text-lg">
              আমি একজন ফ্রন্টএন্ড ওয়েব ডেভেলপার। গিটহাব এবং ভেরসেল ব্যবহার করে নিয়মিত আমার প্রজেক্টগুলো লাইভ ও ম্যানেজ করে থাকি।
            </p>
          </div>
        )}
              ...
              {projects.map((project, index) => (
                <div key={index} className="bg-slate-900 border border-slate-800 rounded-2xl p-6 hover:border-slate-700 transition shadow-lg">
                  ...
                  <a 
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600/20 hover:bg-blue-600/30 text-blue-400 rounded-xl text-sm font-medium transition border border-blue-500/30"
                  >
